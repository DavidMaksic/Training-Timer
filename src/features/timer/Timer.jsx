   ...
   return (
      <div
         className={`flex flex-col pb-5 gap-8 sm:gap-28 ${
            ...
            isPreparing && isPaused ? 'bg-yellow_paused' : ''
         } ${isWorking && isPaused ? 'bg-green-500' : ''} ${
            isResting && isPaused ? 'bg-violet_paused' : ''
         } ${
      ...
      >
         ...
         <div className="flex flex-col items-center justify-center gap-8 pb-20">
            ...
            <span
               ...
               } ${isPreparing && isPaused ? 'text-yellow_text_paused' : ''} ${
                  isWorking && isPaused ? 'text-green-300' : ''
               } ${isResting && isPaused ? 'text-violet_text_paused' : ''}`}
            >
               {isPreparing && 'PREPARE'}
               {isWorking && 'WORK'}
               {isResting && 'REST'}
